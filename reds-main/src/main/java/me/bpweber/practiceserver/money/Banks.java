...
public class Banks implements Listener {
    ...
    public void onClick(PlayerInteractEvent e) {
        ...
        if (e.getAction() == Action.RIGHT_CLICK_BLOCK && e.getClickedBlock().getType() == Material.ENDER_CHEST) {
            e.setCancelled(true);
            if (!e.getPlayer().getOpenInventory().getTitle().equalsIgnoreCase("Bank Chest (1/1)")) {
    ...
    public void onInvOpen(InventoryOpenEvent e) {
        if (e.getInventory().getName().equals("Bank Chest (1/1)")) {
            ...
            im.setDisplayName(ChatColor.GREEN.toString() + Economy.getBalance(e.getPlayer().getUniqueId())
    ...
    public void onInvClick(final InventoryClickEvent e) {
        ...
        if (e.getInventory().getName().equals("Bank Chest (1/1)")) {
            ...
            if (e.isShiftClick() && e.getCurrentItem() != null && e.getCurrentItem().getType() == Material.EMERALD) {
                ...
                e.getInventory().setItem(58, this.gemBalance(Economy.getBalance(p.getUniqueId())));
                p.updateInventory();
