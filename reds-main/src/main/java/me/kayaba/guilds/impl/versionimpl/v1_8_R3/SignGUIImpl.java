...
import me.kayaba.guilds.impl.versionimpl.v1_8_R3.packet.PacketPlayInUpdateSign;
...
public class SignGUIImpl extends AbstractSignGui {
    ...
    @Override
    public void open(Player player, String[] defaultText, SignGUI.SignGUIListener response) {
        try {
        ...
        new AbstractPacketHandler("PacketPlayInUpdateSign") {
            ...
            public void handle(PacketReceiveEvent event) {
                try {
                    ...
                    final SignGUI.SignGUIListener response = getListeners().remove(player.getUniqueId());
