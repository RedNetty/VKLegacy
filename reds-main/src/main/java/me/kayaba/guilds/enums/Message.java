...
public abstract class Message {
    ...
    public static MessageWrapper CHAT_ADMIN_GUILD_RESET_POINTS_KayabaLUE;
    ...
    public static MessageWrapper CHAT_USAGE_GA_ACCESS;
    public static MessageWrapper CHAT_USAGE_GA_RELOAD;
    public static MessageWrapper CHAT_USAGE_GA_SAVE;
    public static MessageWrapper CHAT_USAGE_GA_CHATSPY;
    public static MessageWrapper CHAT_USAGE_GA_CONFIG_ACCESS = new MessageWrapperImpl(MessageWrapper.Flag.NOPREFIX);
    public static MessageWrapper CHAT_USAGE_GA_CONFIG_GET;
    public static MessageWrapper CHAT_USAGE_GA_CONFIG_RELOAD;
    public static MessageWrapper CHAT_USAGE_GA_CONFIG_RESET;
    public static MessageWrapper CHAT_USAGE_GA_CONFIG_SAVE;
    public static MessageWrapper CHAT_USAGE_GA_CONFIG_SET;

    public static MessageWrapper CHAT_USAGE_GA_PLAYER_ACCESS;
    public static MessageWrapper CHAT_USAGE_GA_PLAYER_SET_POINTS;

    public static MessageWrapper CHAT_USAGE_GA_GUILD_ACCESS;
    public static MessageWrapper CHAT_USAGE_GA_GUILD_SET_POINTS;
    public static MessageWrapper CHAT_USAGE_GA_GUILD_SET_LIVES;
    public static MessageWrapper CHAT_USAGE_GA_GUILD_SET_TIMEREST;
    public static MessageWrapper CHAT_USAGE_GA_GUILD_SET_NAME;
    public static MessageWrapper CHAT_USAGE_GA_GUILD_SET_TAG;
    public static MessageWrapper CHAT_USAGE_GA_GUILD_SET_SLOTS;
    public static MessageWrapper CHAT_USAGE_GA_GUILD_SET_LEADER;
    public static MessageWrapper CHAT_USAGE_GA_GUILD_SET_LIVEREGENERATIONTIME;
    public static MessageWrapper CHAT_USAGE_GA_GUILD_ABANDON;
    public static MessageWrapper CHAT_USAGE_GA_GUILD_BANK_PAY;
    public static MessageWrapper CHAT_USAGE_GA_GUILD_BANK_WITHDRAW;
    public static MessageWrapper CHAT_USAGE_GA_GUILD_INACTIVE_LIST;
    public static MessageWrapper CHAT_USAGE_GA_GUILD_INVITE;
    public static MessageWrapper CHAT_USAGE_GA_GUILD_KICK;
    public static MessageWrapper CHAT_USAGE_GA_GUILD_LIST;
    public static MessageWrapper CHAT_USAGE_GA_GUILD_PURGE;
    public static MessageWrapper CHAT_USAGE_GA_GUILD_TP;
    public static MessageWrapper CHAT_USAGE_GA_GUILD_RESET_POINTS;
    public static MessageWrapper CHAT_USAGE_GA_GUILD_RANK_ACCESS;
    public static MessageWrapper CHAT_USAGE_GA_GUILD_RANK_DELETE;
    public static MessageWrapper CHAT_USAGE_GA_GUILD_RANK_LIST;

    public static MessageWrapper CHAT_USAGE_GA_HOLOGRAM_ACCESS;
    public static MessageWrapper CHAT_USAGE_GA_HOLOGRAM_LIST;
    public static MessageWrapper CHAT_USAGE_GA_HOLOGRAM_TELEPORT_SELF;
    public static MessageWrapper CHAT_USAGE_GA_HOLOGRAM_TELEPORT_HERE;
    public static MessageWrapper CHAT_USAGE_GA_HOLOGRAM_DELETE;
    public static MessageWrapper CHAT_USAGE_GA_HOLOGRAM_ADDTOP;
    public static MessageWrapper CHAT_USAGE_GUILD_ACCESS;

    public static MessageWrapper CHAT_USAGE_GA_REGION_ACCESS = new MessageWrapperImpl(MessageWrapper.Flag.NOPREFIX);
    public static MessageWrapper CHAT_USAGE_GA_REGION_BYPASS;
    public static MessageWrapper CHAT_USAGE_GA_REGION_DELETE;
    public static MessageWrapper CHAT_USAGE_GA_REGION_LIST;
    public static MessageWrapper CHAT_USAGE_GA_REGION_SPECTATE;
    public static MessageWrapper CHAT_USAGE_GA_REGION_TELEPORT;
    public static MessageWrapper CHAT_USAGE_GA_REGION_BUY;

    public static MessageWrapper CHAT_USAGE_GA_MIGRATE;
